---
description: >-
  The Ozmium ($OZ) token is a utility token for access to various features and
  services within the ecosystem. The token uses the Clanker v0.3.1 smart
  contract and operates on the Base network.
icon: hive
---
